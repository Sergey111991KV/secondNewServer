...
filterOfData time condition = do
        ...
        case result of
                                [ ]             ->  do
                                                Log.logIn Log.Error $ "Error filterOfData " ++ (errorText DataErrorPostgreSQL)
...
filterAuthor name = do
        ...
        case result of
                                [ ]          ->  do
                                                Log.logIn Log.Error $ "Error filterAuthor " ++ (errorText DataErrorPostgreSQL)
                                                return $ Left DataErrorPostgreSQL
                                news         ->  do
...
filterCategory cat = do
        ...
        case result of
                                [ ]          ->  do
                                                Log.logIn Log.Error $ "Error filterCategory " ++ (errorText DataErrorPostgreSQL)
                                                return $ Left DataErrorPostgreSQL
                                news         ->  do
...
filterOneOfTegs idTarray = do
        ...
        case result of
                                [ ]             ->  do
                                                Log.logIn Log.Error $ "Error filterOneOfTegs " ++ (errorText DataErrorPostgreSQL)
                                                return $ Left DataErrorPostgreSQL
                                news            ->  do
...
filterAllOfTegs idTarray = do
        ...
        case result of
                                [ ]             ->  do
                                                Log.logIn Log.Error $ "Error filterAllOfTegs " ++ (errorText DataErrorPostgreSQL)
                                                return $ Left DataErrorPostgreSQL
                                news            ->  do
...
filterContent txt = do 
                ...
                case result of
                                        [ ]          ->  do
                                                        Log.logIn Log.Error $ "Error filterContent " ++ (errorText DataErrorPostgreSQL)
                                                        return $ Left DataErrorPostgreSQL
                                        news         ->  do
