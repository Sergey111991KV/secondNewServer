...
instance ConvertClas Category1 where
  ...
  convertFromCatEntArray (x:xs) =
    (convertFromCategory x :: Category1) : convertFromCatEntArray xs
...
instance ConvertClas Category2 where
  ...
  convertFromCatEntArray [] = []
  convertFromCatEntArray (x:xs) =
    (convertFromCategory x :: Category2) : convertFromCatEntArray xs
...
instance ConvertClas Category3 where
  ...
  convertFromCatEntArray [] = []
  convertFromCatEntArray (x:xs) =
    (convertFromCategory x :: Category3) : convertFromCatEntArray xs
