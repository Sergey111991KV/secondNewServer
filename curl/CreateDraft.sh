...
curl -b  'sId=M3nH3RlHTR45bpwbRCal5q3xr7069kVT' -d '{"main_photo_url":"test 1 main photo url","news_id_draft":1,"id_draft":10,"other_photo_url":{"fromPGArray":["test 1 other photo","test 1 other photo2"]},"text_draft":"test 2 draft","short_name":"TestDragtForFirstNews","data_create_draft":"1970-01-01T00:00:00Z"}'  -X POST http://localhost:3000/api/create/draft  -H «Content-Type:application/json»
